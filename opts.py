...
def parse_opts():
    ...
    parser.add_argument('--annotation_path', default='/nfsmount/majid/multimodal/Emotion_recognition_T/ravdess_preprocessing/annotations.csv', type=str, help='Annotation file path')
    ...
    parser.add_argument('--n_classes', default=23, type=int, help='Number of classes')
    ...
    parser.add_argument('--pretrain_path', default='/nfsmount/majid/multimodal/5fps/EfficientFace_Trained_on_AffectNet7.pth.tar', type=str, help='Pretrained model (.pth), efficientface')
